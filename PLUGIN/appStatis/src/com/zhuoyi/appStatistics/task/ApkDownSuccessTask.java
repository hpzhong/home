...
public class ApkDownSuccessTask extends UploadTask {
	...
	public ApkDownSuccessTask(Context context, Handler handler, ApkStatisticInfo apkInfo) {
		super(handler);
	...
	private void putApkStatisInfo(){
		...
		try{      
			...
			//mJsonOb.put("IS", imsi);
			mJsonOb.put("ac_id", ActionType.APK_DOWNLOAD_SUCCESS);
