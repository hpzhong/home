...
public class WalkPrimaryPlan extends Activity {
	private ListView lv_first_week, lv_second_week, lv_third_week,
			lv_fourth_week, lv_fifth_week, lv_sixth_week, lv_seventh_week,
			lv_eighth_week;
	private TextView tv_first_week, tv_second_week, tv_third_week,
			tv_fourth_week, tv_fifth_week, tv_sixth_week, tv_seventh_week,
			tv_eighth_week, tv_title;;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_first_week = (TextView) findViewById(R.id.tv_first_week);
		tv_second_week = (TextView) findViewById(R.id.tv_second_week);
		tv_third_week = (TextView) findViewById(R.id.tv_third_week);
		tv_fourth_week = (TextView) findViewById(R.id.tv_fourth_week);
	...
	private class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (arr[position].equals(getResources().getString(R.string.day_of_rest))) {
	...
	public void getWeekPlan(int tmp){
		switch (tmp) {
		case 0x001:
			tv_first_week.setBackgroundResource(R.drawable.week_bg_1);
			tv_second_week.setBackgroundResource(R.drawable.week_bg_1);
			tv_third_week.setBackgroundResource(R.drawable.week_bg_1);
			tv_fourth_week.setBackgroundResource(R.drawable.week_bg_1);
			...
			break;
		case 0x002:
			tv_first_week.setBackgroundResource(R.drawable.week_bg_2);
			tv_second_week.setBackgroundResource(R.drawable.week_bg_2);
			tv_third_week.setBackgroundResource(R.drawable.week_bg_2);
			tv_fourth_week.setBackgroundResource(R.drawable.week_bg_2);
			...
			break;
		case 0x003:
			tv_first_week.setBackgroundResource(R.drawable.week_bg_3);
			tv_second_week.setBackgroundResource(R.drawable.week_bg_3);
			tv_third_week.setBackgroundResource(R.drawable.week_bg_3);
			tv_fourth_week.setBackgroundResource(R.drawable.week_bg_3);
			tv_fifth_week.setBackgroundResource(R.drawable.week_bg_3);
			tv_sixth_week.setBackgroundResource(R.drawable.week_bg_3);
			...
			break;
		case 0x004:
			tv_first_week.setBackgroundResource(R.drawable.week_bg_4);
			tv_second_week.setBackgroundResource(R.drawable.week_bg_4);
			tv_third_week.setBackgroundResource(R.drawable.week_bg_4);
			tv_fourth_week.setBackgroundResource(R.drawable.week_bg_4);
			tv_fifth_week.setBackgroundResource(R.drawable.week_bg_4);
			tv_sixth_week.setBackgroundResource(R.drawable.week_bg_4);
			tv_seventh_week.setBackgroundResource(R.drawable.week_bg_4);
			tv_eighth_week.setBackgroundResource(R.drawable.week_bg_4);
			...
			break;
		case 0x005:
			tv_first_week.setBackgroundResource(R.drawable.week_bg_5);
			tv_second_week.setBackgroundResource(R.drawable.week_bg_5);
			tv_third_week.setBackgroundResource(R.drawable.week_bg_5);
			tv_fourth_week.setBackgroundResource(R.drawable.week_bg_5);
			tv_fifth_week.setBackgroundResource(R.drawable.week_bg_5);
			tv_sixth_week.setBackgroundResource(R.drawable.week_bg_5);
			tv_seventh_week.setBackgroundResource(R.drawable.week_bg_5);
			tv_eighth_week.setBackgroundResource(R.drawable.week_bg_5);
