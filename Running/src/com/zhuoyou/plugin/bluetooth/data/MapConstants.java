...
public class MapConstants {
    ...
    public static final ArrayList<String> messageItemField = new ArrayList<String>(){
        {add("handle"); add("subject");add("datetime");add("sender_name");add("sender_addressing");add("recipient_name");add("recipient_addressing");add("type");add("size");add("text");add("reception_status");add("attachment_size");add("priority");add("read");add("sent");add("protected");}
        };   
