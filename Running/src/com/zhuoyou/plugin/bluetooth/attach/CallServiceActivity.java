...
public class CallServiceActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_title.setText(R.string.call_preference_title);
		...
		enable_call_service = (LinearLayout)findViewById(R.id.enable_call_service);
		enable_call_service.setOnClickListener(this);
		enable_summary = (TextView)findViewById(R.id.enable_summary);
		enable_status = (CheckBox)findViewById(R.id.enable_status);
		enable_status.setChecked(sSharedPreferences.getBoolean(PreferenceData.PREFERENCE_KEY_CALL ,true));
		if (enable_status.isChecked()) {
			enable_summary.setText(R.string.call_preference_summary_yes);
		} else {
			enable_summary.setText(R.string.call_preference_summary_no);
		}
	}
