...
public class DurationPopupWindow extends PopupWindow implements OnEndFlingListener{
	...
	public DurationPopupWindow(Context context, int hourSelection, int minuteSelection){
		...
		lastMinuteData = context.getResources().getStringArray(R.array.last_minute);
		lastHourData = context.getResources().getStringArray(R.array.duration_hour);
		hourAdapter = new MyWheelView(lastHourData, context);
		minuteAdapter = new MyWheelView(lastMinuteData, context);
