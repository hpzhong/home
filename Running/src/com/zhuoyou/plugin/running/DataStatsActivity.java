...
public class DataStatsActivity extends Activity implements OnScrollListener {
	...
	private void setViews() {
		switch (viewType) {
		case STEPVIEW:
			tv_title.setText(R.string.walking_statistics);
			setStepView();
			break;
		case CALORIEVIEW:
			tv_title.setText(R.string.calories_statistics);
			setCalorieView();
			break;
		default:
			break;
	...
	private void setStepView() {
		...
		text_stats_group1.setTypeface(mNumberTP);
		...
		text_stats_group2.setTypeface(mNumberTP);
	...
	private void setCalorieView() {
		...
		text_stats_group1.setTypeface(mNumberTP);
		unit_stats_group1.setText(R.string.kcal);
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			if (viewType == STEPVIEW) {
				...
				case R.id.rb_stats_daily:
					...
					title_stats_group1.setText(R.string.total_steps);
					title_stats_group2.setText(R.string.total_distance);
					prepareDataSource();
					setBarView();
					break;
				case R.id.rb_stats_weekly:
					...
					title_stats_group1.setText(R.string.wtotal_steps);
					title_stats_group2.setText(R.string.wtotal_distance);
					prepareDataSource();
					setPolylineView();
				...
				case R.id.rb_stats_monthly:
					...
					bg_scrollview.setVisibility(View.GONE);
					bg_scrollview_circle.setVisibility(View.VISIBLE);
					title_stats_group1.setText(R.string.mtotal_steps);
					title_stats_group2.setText(R.string.mtotal_distance);
					prepareDataSource();
					setPolylineView();
					circle.setImageResource(R.drawable.circle_stats_blue);
					circle.setY(((Float)YList.get(YList.size() - 1)).floatValue());
				...
				case R.id.rb_stats_daily:
					...
					bg_scrollview.setVisibility(View.VISIBLE);
					bg_scrollview_circle.setVisibility(View.GONE);
					title_stats_group1.setText(R.string.burn);
					prepareDataSource();
					setBarView();
					break;
				case R.id.rb_stats_weekly:
					...
					bg_scrollview.setVisibility(View.GONE);
					bg_scrollview_circle.setVisibility(View.VISIBLE);
					title_stats_group1.setText(R.string.wburn);
					prepareDataSource();
					setPolylineView();
				...
				case R.id.rb_stats_monthly:
					...
					bg_scrollview.setVisibility(View.GONE);
					bg_scrollview_circle.setVisibility(View.VISIBLE);
					title_stats_group1.setText(R.string.mburn);
					prepareDataSource();
					setPolylineView();
					circle.setImageResource(R.drawable.circle_stats_orange);
					circle.setY(((Float)YList.get(YList.size() - 1)).floatValue());
