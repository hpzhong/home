...
// | |
// +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
// 字段名称 字段大小 取�1�?�范�?�? 功能说明
// 基础协议版本
// (basic ver) 1(byte) [1,255] 标识基础协议的版本号，不会频繁更新，�?�?�开始版�?�?
// 协议包长�?�?
// (length) 4 [32,16777215] 整个协议包长度，�?�?小�1�?�为协议头大�?�?(32)，高位字节序
// 事务标识
// (transaction) 16 GUID
// 参照GUID的生成算法，由请求或者�1�?�知的发送�1�?�保证其在任何时间�1�?�地点�1�?�平台唯�?�?，请求和响应消息的事物标识必须一致�1�?�该标识用于保证请求和响应的唯一对应以及消息的不重复�?�?
// 原语类型
// (type) 1 [0,255] 目前支持请求(0)，响�?�?(1)，�1�?�知�?�?�，递�1�?�?�?(3)
// 保留字段
// （reserved�?�? 2 N/A 基础协议头的保留字段
// 消息编码
