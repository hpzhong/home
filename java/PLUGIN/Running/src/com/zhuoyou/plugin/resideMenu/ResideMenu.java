...
public class ResideMenu extends FrameLayout{
    ...
    private List<ResideMenuRightItem> rightMenuItems;
    ...
    private void initViews(Context context){
        ...
        layoutDevice = (LinearLayout) findViewById(R.id.layout_device);
    }
    ...
    private void initValue(Activity activity){
        ...
        rightMenuItems  = new ArrayList<ResideMenuRightItem>();
        ...
        ViewGroup parent = (ViewGroup) leftMenu.getParent();
        parent.removeView(leftMenu);
        parent.removeView(rightMenu);
    }
    ...
    public void addMenuRightItem(ResideMenuRightItem menuItem){
        this.rightMenuItems.add(menuItem);
        layoutRightMenu.addView(menuItem);
    }

    public void addMenuLeftTop(ResideMenuLeftTop menuTop) {
    	layoutInfo.addView(menuTop);
    }

    public void addMenuBottom(ResideMenuLeftBottom menuBottom) {
    	layoutSetting.addView(menuBottom);
    }
    
    public void addMenuRightTop(ResideMenuRightTop menuTop) {
    	layoutDevice.addView(menuTop);
    }
    ...
    public void openMenu(int direction){
        ...
        if (direction == DIRECTION_RIGHT) {
			Intent intent = new Intent("com.tyd.running.get.device");
    ...
    private boolean isInIgnoredView(MotionEvent ev) {
        ...
        for (View v : ignoredViews) {
            ...
            rect.set(50, 0, getScreenWidth()-50, getScreenHeight());
    ...
    private float getTargetScale(float currentRawX){
        float scaleFloatX = ((currentRawX - lastRawX) / getScreenWidth()) * 0.25f;
